    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body py-3">
            <table  class="table table-hover">
                ...
                <tbody>
                    <?php
                    $query="SELECT * FROM peminjaman WHERE status_peminjaman='Terpinjam'ORDER BY ROWID";
                    ...
                    <tr>
                        ...
                        ?>
                        <td>
                            <a href="index.php?page=pengembalianCreate&id_peminjaman=<?= $rows ->ID_PEMINJAMAN;?>"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-dark"></i></a>
                        </td>
                    </tr>
                    <?php	
                        $no++;
